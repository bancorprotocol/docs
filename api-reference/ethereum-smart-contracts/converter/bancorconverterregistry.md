...
* [`getLiquidityPoolByReserveConfig(contract IBancorConverter _converter)`](bancorconverterregistry.md#BancorConverterRegistry-getLiquidityPoolByReserveConfig-contract-IBancorConverter-)
...
## Function `getLiquidityPoolByReserveConfig(contract IBancorConverter _converter) → contract ISmartToken` <a id="BancorConverterRegistry-getLiquidityPoolByReserveConfig-contract-IBancorConverter-"></a>
