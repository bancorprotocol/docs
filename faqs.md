...
With the release of Vortex, you'll also be able to use vBNT to borrow against your staked liquidity by swapping your vBNT for any token in the network. If activated, the system can also generate swap fees burned for vBNT. [**See the Bancor Vortex Proposal** for more details.](https://gov.bancor.network/t/bancor-vortex-part-2-vbnt-whitelist-proposal/537)
