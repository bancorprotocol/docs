...
- [`withdrawTokens(contract IReserveToken _token, address _to, uint256 _amount)`](#LiquidityProtectionStore-withdrawTokens-contract-IReserveToken-address-uint256-)
...
- [`addProtectedLiquidity(address _provider, contract IDSToken _poolToken, contract IReserveToken _reserveToken, uint256 _poolAmount, uint256 _reserveAmount, uint256 _reserveRateN, uint256 _reserveRateD, uint256 _timestamp)`](#LiquidityProtectionStore-addProtectedLiquidity-address-contract-IDSToken-contract-IReserveToken-uint256-uint256-uint256-uint256-uint256-)
...
- [`systemBalance(contract IReserveToken _token)`](#LiquidityProtectionStore-systemBalance-contract-IReserveToken-)

- [`incSystemBalance(contract IReserveToken _token, uint256 _amount)`](#LiquidityProtectionStore-incSystemBalance-contract-IReserveToken-uint256-)

- [`decSystemBalance(contract IReserveToken _token, uint256 _amount)`](#LiquidityProtectionStore-decSystemBalance-contract-IReserveToken-uint256-)
...
- [`totalProtectedReserveAmount(contract IDSToken _poolToken, contract IReserveToken _reserveToken)`](#LiquidityProtectionStore-totalProtectedReserveAmount-contract-IDSToken-contract-IReserveToken-)

# Events:

- [`ProtectionAdded(address _provider, contract IDSToken _poolToken, contract IReserveToken _reserveToken, uint256 _poolAmount, uint256 _reserveAmount)`](#LiquidityProtectionStore-ProtectionAdded-address-contract-IDSToken-contract-IReserveToken-uint256-uint256-)
...
- [`ProtectionRemoved(address _provider, contract IDSToken _poolToken, contract IReserveToken _reserveToken, uint256 _poolAmount, uint256 _reserveAmount)`](#LiquidityProtectionStore-ProtectionRemoved-address-contract-IDSToken-contract-IReserveToken-uint256-uint256-)
...
- [`SystemBalanceUpdated(contract IReserveToken _token, uint256 _prevAmount, uint256 _newAmount)`](#LiquidityProtectionStore-SystemBalanceUpdated-contract-IReserveToken-uint256-uint256-)

## Function `withdrawTokens(contract IReserveToken _token, address _to, uint256 _amount)` {#LiquidityProtectionStore-withdrawTokens-contract-IReserveToken-address-uint256-}
...
## Function `protectedLiquidity(uint256 _id) → address, contract IDSToken, contract IReserveToken, uint256, uint256, uint256, uint256, uint256` {#LiquidityProtectionStore-protectedLiquidity-uint256-}
...
## Function `addProtectedLiquidity(address _provider, contract IDSToken _poolToken, contract IReserveToken _reserveToken, uint256 _poolAmount, uint256 _reserveAmount, uint256 _reserveRateN, uint256 _reserveRateD, uint256 _timestamp) → uint256` {#LiquidityProtectionStore-addProtectedLiquidity-address-contract-IDSToken-contract-IReserveToken-uint256-uint256-uint256-uint256-uint256-}
...
## Function `systemBalance(contract IReserveToken _token) → uint256` {#LiquidityProtectionStore-systemBalance-contract-IReserveToken-}
...
## Function `incSystemBalance(contract IReserveToken _token, uint256 _amount)` {#LiquidityProtectionStore-incSystemBalance-contract-IReserveToken-uint256-}
...
## Function `decSystemBalance(contract IReserveToken _token, uint256 _amount)` {#LiquidityProtectionStore-decSystemBalance-contract-IReserveToken-uint256-}
...
## Function `totalProtectedReserveAmount(contract IDSToken _poolToken, contract IReserveToken _reserveToken) → uint256` {#LiquidityProtectionStore-totalProtectedReserveAmount-contract-IDSToken-contract-IReserveToken-}
...
## Event `ProtectionAdded(address _provider, contract IDSToken _poolToken, contract IReserveToken _reserveToken, uint256 _poolAmount, uint256 _reserveAmount)` {#LiquidityProtectionStore-ProtectionAdded-address-contract-IDSToken-contract-IReserveToken-uint256-uint256-}
...
## Event `ProtectionRemoved(address _provider, contract IDSToken _poolToken, contract IReserveToken _reserveToken, uint256 _poolAmount, uint256 _reserveAmount)` {#LiquidityProtectionStore-ProtectionRemoved-address-contract-IDSToken-contract-IReserveToken-uint256-uint256-}
...
## Event `SystemBalanceUpdated(contract IReserveToken _token, uint256 _prevAmount, uint256 _newAmount)` {#LiquidityProtectionStore-SystemBalanceUpdated-contract-IReserveToken-uint256-uint256-}
