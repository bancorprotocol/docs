...
- [`addPoolToWhitelist(contract IConverterAnchor _poolAnchor)`](#LiquidityProtectionStore-addPoolToWhitelist-contract-IConverterAnchor-)

- [`removePoolFromWhitelist(contract IConverterAnchor _poolAnchor)`](#LiquidityProtectionStore-removePoolFromWhitelist-contract-IConverterAnchor-)

- [`whitelistedPoolCount()`](#LiquidityProtectionStore-whitelistedPoolCount--)

- [`whitelistedPools()`](#LiquidityProtectionStore-whitelistedPools--)

- [`whitelistedPool(uint256 _index)`](#LiquidityProtectionStore-whitelistedPool-uint256-)

- [`isPoolWhitelisted(contract IConverterAnchor _poolAnchor)`](#LiquidityProtectionStore-isPoolWhitelisted-contract-IConverterAnchor-)
...
- [`PoolWhitelistUpdated(contract IConverterAnchor _poolAnchor, bool _added)`](#LiquidityProtectionStore-PoolWhitelistUpdated-contract-IConverterAnchor-bool-)
...
# Function `addPoolToWhitelist(contract IConverterAnchor _poolAnchor)` {#LiquidityProtectionStore-addPoolToWhitelist-contract-IConverterAnchor-}
...
# Function `removePoolFromWhitelist(contract IConverterAnchor _poolAnchor)` {#LiquidityProtectionStore-removePoolFromWhitelist-contract-IConverterAnchor-}
...
# Function `whitelistedPoolCount() → uint256` {#LiquidityProtectionStore-whitelistedPoolCount--}
...
# Function `whitelistedPools() → contract IConverterAnchor[]` {#LiquidityProtectionStore-whitelistedPools--}
...
# Function `whitelistedPool(uint256 _index) → contract IConverterAnchor` {#LiquidityProtectionStore-whitelistedPool-uint256-}
...
# Function `isPoolWhitelisted(contract IConverterAnchor _poolAnchor) → bool` {#LiquidityProtectionStore-isPoolWhitelisted-contract-IConverterAnchor-}
...
# Event `PoolWhitelistUpdated(contract IConverterAnchor _poolAnchor, bool _added)` {#LiquidityProtectionStore-PoolWhitelistUpdated-contract-IConverterAnchor-bool-}
