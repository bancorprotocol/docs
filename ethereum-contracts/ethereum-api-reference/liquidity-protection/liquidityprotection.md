...
- [`constructor(address[8] _contractAddresses)`](#LiquidityProtection-constructor-address-8--)
...
- [`transferWalletOwnership(address _newOwner)`](#LiquidityProtection-transferWalletOwnership-address-)
...
## Function `constructor(address[8] _contractAddresses)` {#LiquidityProtection-constructor-address-8--}
...
## Function `transferWalletOwnership(address _newOwner)` {#LiquidityProtection-transferWalletOwnership-address-}
