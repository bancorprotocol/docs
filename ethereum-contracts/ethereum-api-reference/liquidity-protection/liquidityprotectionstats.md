...
- [`increaseTotalAmounts(address provider, contract IDSToken poolToken, contract IReserveToken reserveToken, uint256 poolAmount, uint256 reserveAmount)`](#LiquidityProtectionStats-increaseTotalAmounts-address-contract-IDSToken-contract-IReserveToken-uint256-uint256-)

- [`decreaseTotalAmounts(address provider, contract IDSToken poolToken, contract IReserveToken reserveToken, uint256 poolAmount, uint256 reserveAmount)`](#LiquidityProtectionStats-decreaseTotalAmounts-address-contract-IDSToken-contract-IReserveToken-uint256-uint256-)
...
- [`totalReserveAmount(contract IDSToken poolToken, contract IReserveToken reserveToken)`](#LiquidityProtectionStats-totalReserveAmount-contract-IDSToken-contract-IReserveToken-)

- [`totalProviderAmount(address provider, contract IDSToken poolToken, contract IReserveToken reserveToken)`](#LiquidityProtectionStats-totalProviderAmount-address-contract-IDSToken-contract-IReserveToken-)
...
- [`seedReserveAmounts(contract IDSToken[] poolTokens, contract IReserveToken[] reserveTokens, uint256[] reserveAmounts)`](#LiquidityProtectionStats-seedReserveAmounts-contract-IDSToken---contract-IReserveToken---uint256---)

- [`seedProviderAmounts(address[] providers, contract IDSToken[] poolTokens, contract IReserveToken[] reserveTokens, uint256[] reserveAmounts)`](#LiquidityProtectionStats-seedProviderAmounts-address---contract-IDSToken---contract-IReserveToken---uint256---)
...
## Function `increaseTotalAmounts(address provider, contract IDSToken poolToken, contract IReserveToken reserveToken, uint256 poolAmount, uint256 reserveAmount)` {#LiquidityProtectionStats-increaseTotalAmounts-address-contract-IDSToken-contract-IReserveToken-uint256-uint256-}
...
## Function `decreaseTotalAmounts(address provider, contract IDSToken poolToken, contract IReserveToken reserveToken, uint256 poolAmount, uint256 reserveAmount)` {#LiquidityProtectionStats-decreaseTotalAmounts-address-contract-IDSToken-contract-IReserveToken-uint256-uint256-}
...
## Function `totalReserveAmount(contract IDSToken poolToken, contract IReserveToken reserveToken) → uint256` {#LiquidityProtectionStats-totalReserveAmount-contract-IDSToken-contract-IReserveToken-}
...
## Function `totalProviderAmount(address provider, contract IDSToken poolToken, contract IReserveToken reserveToken) → uint256` {#LiquidityProtectionStats-totalProviderAmount-address-contract-IDSToken-contract-IReserveToken-}
...
## Function `seedReserveAmounts(contract IDSToken[] poolTokens, contract IReserveToken[] reserveTokens, uint256[] reserveAmounts)` {#LiquidityProtectionStats-seedReserveAmounts-contract-IDSToken---contract-IReserveToken---uint256---}
...
## Function `seedProviderAmounts(address[] providers, contract IDSToken[] poolTokens, contract IReserveToken[] reserveTokens, uint256[] reserveAmounts)` {#LiquidityProtectionStats-seedProviderAmounts-address---contract-IDSToken---contract-IReserveToken---uint256---}
