...
- [`constructor(contract IERC20Token token, contract IContractRegistry registry)`](#LiquidityProtectionSettings-constructor-contract-IERC20Token-contract-IContractRegistry-)
...
- [`addLiquidityDisabled(contract IConverterAnchor poolAnchor, contract IERC20Token reserveToken)`](#LiquidityProtectionSettings-addLiquidityDisabled-contract-IConverterAnchor-contract-IERC20Token-)
...
- [`disableAddLiquidity(contract IConverterAnchor poolAnchor, contract IERC20Token reserveToken, bool disable)`](#LiquidityProtectionSettings-disableAddLiquidity-contract-IConverterAnchor-contract-IERC20Token-bool-)
...
- [`AddLiquidityDisabled(contract IConverterAnchor poolAnchor, contract IERC20Token reserveToken, bool disabled)`](#LiquidityProtectionSettings-AddLiquidityDisabled-contract-IConverterAnchor-contract-IERC20Token-bool-)

## Function `constructor(contract IERC20Token token, contract IContractRegistry registry)` {#LiquidityProtectionSettings-constructor-contract-IERC20Token-contract-IContractRegistry-}
...
## Function `networkToken() → contract IERC20Token` {#LiquidityProtectionSettings-networkToken--}
...
## Function `addLiquidityDisabled(contract IConverterAnchor poolAnchor, contract IERC20Token reserveToken) → bool` {#LiquidityProtectionSettings-addLiquidityDisabled-contract-IConverterAnchor-contract-IERC20Token-}
...
## Function `disableAddLiquidity(contract IConverterAnchor poolAnchor, contract IERC20Token reserveToken, bool disable)` {#LiquidityProtectionSettings-disableAddLiquidity-contract-IConverterAnchor-contract-IERC20Token-bool-}
...
## Event `AddLiquidityDisabled(contract IConverterAnchor poolAnchor, contract IERC20Token reserveToken, bool disabled)` {#LiquidityProtectionSettings-AddLiquidityDisabled-contract-IConverterAnchor-contract-IERC20Token-bool-}
