...
* [`addSubscriber(contract ILiquidityProvisionEventsSubscriber subscriber)`](liquidityprotectionsettings.md#LiquidityProtectionSettings-addSubscriber-contract-ILiquidityProvisionEventsSubscriber-)
* [`removeSubscriber(contract ILiquidityProvisionEventsSubscriber subscriber)`](liquidityprotectionsettings.md#LiquidityProtectionSettings-removeSubscriber-contract-ILiquidityProvisionEventsSubscriber-)
...
* [`SubscriberUpdated(contract ILiquidityProvisionEventsSubscriber subscriber, bool added)`](liquidityprotectionsettings.md#LiquidityProtectionSettings-SubscriberUpdated-contract-ILiquidityProvisionEventsSubscriber-bool-)
...
### Function `addSubscriber(contract ILiquidityProvisionEventsSubscriber subscriber)` <a id="LiquidityProtectionSettings-addSubscriber-contract-ILiquidityProvisionEventsSubscriber-"></a>
...
### Function `removeSubscriber(contract ILiquidityProvisionEventsSubscriber subscriber)` <a id="LiquidityProtectionSettings-removeSubscriber-contract-ILiquidityProvisionEventsSubscriber-"></a>
...
### Event `SubscriberUpdated(contract ILiquidityProvisionEventsSubscriber subscriber, bool added)` <a id="LiquidityProtectionSettings-SubscriberUpdated-contract-ILiquidityProvisionEventsSubscriber-bool-"></a>
