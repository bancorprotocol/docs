...
* [`amplificationFactor()`](liquiditypoolv2converter.md#LiquidityPoolV2Converter-amplificationFactor--)
...
* [`removeLiquidityReturnAndFee(contract ISmartToken _poolToken, uint256 _amount)`](liquiditypoolv2converter.md#LiquidityPoolV2Converter-removeLiquidityReturnAndFee-contract-ISmartToken-uint256-)
...
## Function `amplificationFactor() → uint8` <a id="LiquidityPoolV2Converter-amplificationFactor--"></a>
...
## Function `removeLiquidityReturnAndFee(contract ISmartToken _poolToken, uint256 _amount) → uint256, uint256` <a id="LiquidityPoolV2Converter-removeLiquidityReturnAndFee-contract-ISmartToken-uint256-"></a>
