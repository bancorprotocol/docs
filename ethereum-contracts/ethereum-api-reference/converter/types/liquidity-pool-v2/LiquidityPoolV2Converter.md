...
# Event `AmplificationFactorUpdate(uint8 _prevAmplificationFactor, uint8 _newAmplificationFactor)` {#LiquidityPoolV2Converter-AmplificationFactorUpdate-uint8-uint8-}
