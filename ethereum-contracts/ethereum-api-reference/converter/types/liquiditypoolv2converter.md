...
- [`setOracleDeviationFee(uint32 _oracleDeviationFee)`](#LiquidityPoolV2Converter-setOracleDeviationFee-uint32-)
...
- [`liquidationLimit(contract IDSToken _poolToken)`](#LiquidityPoolV2Converter-liquidationLimit-contract-IDSToken-)
...
- [`removeLiquidity(contract IDSToken _poolToken, uint256 _amount, uint256 _minReturn)`](#LiquidityPoolV2Converter-removeLiquidity-contract-IDSToken-uint256-uint256-)

- [`removeLiquidityReturnAndFee(contract IDSToken _poolToken, uint256 _amount)`](#LiquidityPoolV2Converter-removeLiquidityReturnAndFee-contract-IDSToken-uint256-)

# Events:

- [`OracleDeviationFeeUpdate(uint32 _prevFee, uint32 _newFee)`](#LiquidityPoolV2Converter-OracleDeviationFeeUpdate-uint32-uint32-)
...
# Function `setOracleDeviationFee(uint32 _oracleDeviationFee)` {#LiquidityPoolV2Converter-setOracleDeviationFee-uint32-}
...
# Function `poolToken(contract IERC20Token _reserveToken) → contract IDSToken` {#LiquidityPoolV2Converter-poolToken-contract-IERC20Token-}
...
# Function `liquidationLimit(contract IDSToken _poolToken) → uint256` {#LiquidityPoolV2Converter-liquidationLimit-contract-IDSToken-}
...
# Function `removeLiquidity(contract IDSToken _poolToken, uint256 _amount, uint256 _minReturn) → uint256` {#LiquidityPoolV2Converter-removeLiquidity-contract-IDSToken-uint256-uint256-}
...
# Function `removeLiquidityReturnAndFee(contract IDSToken _poolToken, uint256 _amount) → uint256, uint256` {#LiquidityPoolV2Converter-removeLiquidityReturnAndFee-contract-IDSToken-uint256-}
...
# Event `OracleDeviationFeeUpdate(uint32 _prevFee, uint32 _newFee)` {#LiquidityPoolV2Converter-OracleDeviationFeeUpdate-uint32-uint32-}
